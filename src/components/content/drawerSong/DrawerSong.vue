  ...
  <drawer ref="drawer">
    <div class="drawer-song" ref="drawerSong">
      ...
      <div class="song-main">
        ...
        <p v-for="(ar, index) in song.ar" :key="index" class="elellipsis" @click="toAr(ar.id)">
          <span class="iconfont icon-head"></span>
          <span>前往艺人</span>
          <span>{{ar.name}}</span>
        </p>
        <p class="elellipsis" @click="toAl">
      ...
      <div class="like" v-if="$store.state.user">
        <p @click="likeClick">
          <span class="iconfont icon-heart" :class="{red:likeSongStatus}"></span>
          <span>喜欢</span>
        </p>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    toAr(id) {
      this.hideDrawer();
      this.$store.commit("sendArId", id);
      this.$router.push("/artist");
    },
    toAl() {
      this.hideDrawer();
      this.$store.commit("sendListId", this.song.al.id);
    ...
    toComment() {
      ...
      this.$router.push({
        name: "Comment",
        params: { song: this.song, id: this.song.id },
      });
    },
    addList() {
